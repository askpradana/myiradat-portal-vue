        ...
        <Card>
          <CardContent class="pt-6">
            ...
            <blockquote class="text-muted-foreground mb-4">
              "This platform has completely transformed how we handle our data. The automation
              features alone have saved us countless hours every week."
            </blockquote>
            <div class="flex items-center">
              <div class="w-10 h-10 bg-muted rounded-full mr-3"></div>
              <div>
