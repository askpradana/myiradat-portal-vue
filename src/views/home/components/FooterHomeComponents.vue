    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="col-span-1 md:col-span-1">
          <div class="flex items-center space-x-2 mb-6">
            <div class="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
              <span class="text-primary-foreground font-bold text-sm">MY</span>
            </div>
            <span class="text-xl font-bold text-foreground">Iradat</span>
          </div>
          <p class="text-muted-foreground mb-4">
            Transforming data management for modern businesses with powerful, intuitive solutions.
          </p>
      ...
      <div class="mt-12 pt-8 border-t border-border">
        <p class="text-sm text-muted-foreground text-center">
          &copy; {{ new Date().getFullYear() }} Iradat. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
